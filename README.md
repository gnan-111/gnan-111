...
<p align="left">
  ...
  <a href="https://www.photoshop.com/en" target="_blank"><img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/photoshop/photoshop-line.svg" width="40" height="40"/></a></p>
...
#### 💻 Backend & Frameworks
<p align="center">
  <img src="https://img.shields.io/badge/.NET%20Core-512BD4?logo=dotnet&logoColor=white" alt=".NET Core"/>
  <img src="https://img.shields.io/badge/ASP.NET%20MVC-68217A?logo=dotnet&logoColor=white" alt="ASP.NET MVC"/>
  <img src="https://img.shields.io/badge/Web%20API-5C2D91?logo=web&logoColor=white" alt="Web API"/>
  <img src="https://img.shields.io/badge/Entity%20Framework-2C3E50?logo=entity-framework&logoColor=white" alt="Entity Framework"/>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/CI/CD-4B32C3?logo=azure-devops&logoColor=white" alt="CI/CD"/>
  <img src="https://img.shields.io/badge/Agile-008080?logo=scrumalliance&logoColor=white" alt="Agile"/>
</p>
...
☁️ Implementing **Redis caching** and **GraphQL APIs** in modern web apps  
⚙️ Enhancing **Clean Architecture** & **Microservices** design in .NET 9  
...
- 🚗 **TaxiBhai API** – Ride-hailing backend built with ASP.NET Web API, EF Core & Clean Architecture  
- 🧠 **AI Interview Prep Hub** – Fullstack app integrating ChatGPT API with React + .NET Core backend  
- 📅 **Meeting Scheduler API** – .NET 9 Web API with SignalR, Google Calendar sync & Redis cache  
...
<p align="center">✨ “Code with purpose, architect with vision.” ✨</p>
